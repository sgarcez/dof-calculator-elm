...
var _sgarcez$dof_calculator_elm$Types$Model = F2(
	function (a, b) {
		return {input: a, dof: b};
	});
var _sgarcez$dof_calculator_elm$Types$DOF = F3(
	function (a, b, c) {
		return {near: a, far: b, diff: c};
	});
var _sgarcez$dof_calculator_elm$Types$InputParameter = F3(
	function (a, b, c) {
		return {input: a, parsed: b, valid: c};
	});
var _sgarcez$dof_calculator_elm$Types$InputParameters = F3(
	function (a, b, c) {
		return {distance: a, focalLength: b, aperture: c};
	});
var _sgarcez$dof_calculator_elm$Types$UpdateDOF = {ctor: 'UpdateDOF'};
var _sgarcez$dof_calculator_elm$Types$SetAperture = function (a) {
	return {ctor: 'SetAperture', _0: a};
};
var _sgarcez$dof_calculator_elm$Types$SetFocalLength = function (a) {
	return {ctor: 'SetFocalLength', _0: a};
};
var _sgarcez$dof_calculator_elm$Types$SetDistance = function (a) {
	return {ctor: 'SetDistance', _0: a};
};

var _sgarcez$dof_calculator_elm$State$calcDOF = function (input) {
	var _p0 = {ctor: '_Tuple3', _0: input.focalLength.valid, _1: input.aperture.valid, _2: input.distance.valid};
	if ((((_p0.ctor === '_Tuple3') && (_p0._0 === true)) && (_p0._1 === true)) && (_p0._2 === true)) {
		var coc = 3.0e-2;
		var distance = input.distance.parsed * 10;
		var aperture = input.aperture.parsed;
		var focalLength = input.focalLength.parsed;
		var hyperfocal = (focalLength * focalLength) / (aperture * coc);
		var nearpoint = (hyperfocal * distance) / ((hyperfocal + distance) - focalLength);
		var farpoint = (hyperfocal * distance) / (hyperfocal - (distance - focalLength));
		return {
			near: _elm_lang$core$Maybe$Just(nearpoint / 10),
			far: _elm_lang$core$Maybe$Just(farpoint / 10),
			diff: _elm_lang$core$Maybe$Just((farpoint - nearpoint) / 10)
		};
	} else {
		return {near: _elm_lang$core$Maybe$Nothing, far: _elm_lang$core$Maybe$Nothing, diff: _elm_lang$core$Maybe$Nothing};
	}
};
var _sgarcez$dof_calculator_elm$State$parseInput = function (val) {
	var _p1 = _elm_lang$core$String$toFloat(val);
	if (_p1.ctor === 'Ok') {
		var _p3 = _p1._0;
		var _p2 = _elm_lang$core$Native_Utils.cmp(_p3, 0) > 0;
		if (_p2 === true) {
			return {input: val, parsed: _p3, valid: true};
		} else {
			return {input: val, parsed: _p3, valid: false};
		}
	} else {
		return {input: val, parsed: -1, valid: false};
	}
};
var _sgarcez$dof_calculator_elm$State$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p4 = msg;
			switch (_p4.ctor) {
				case 'SetDistance':
					...
					var _v4 = _sgarcez$dof_calculator_elm$Types$UpdateDOF,
						...
						model,
						{
							input: _elm_lang$core$Native_Utils.update(
								oldInput,
								{
									distance: _sgarcez$dof_calculator_elm$State$parseInput(_p4._0)
								})
						});
					msg = _v4;
					model = _v5;
				...
				case 'SetFocalLength':
					var oldInput = model.input;
					var _v6 = _sgarcez$dof_calculator_elm$Types$UpdateDOF,
						...
						model,
						{
							input: _elm_lang$core$Native_Utils.update(
								oldInput,
								{
									focalLength: _sgarcez$dof_calculator_elm$State$parseInput(_p4._0)
								})
						});
					msg = _v6;
					model = _v7;
				...
				case 'SetAperture':
					var oldInput = model.input;
					var _v8 = _sgarcez$dof_calculator_elm$Types$UpdateDOF,
						...
						model,
						{
							input: _elm_lang$core$Native_Utils.update(
								oldInput,
								{
									aperture: _sgarcez$dof_calculator_elm$State$parseInput(_p4._0)
								})
						});
					msg = _v8;
					model = _v9;
				...
				default:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								dof: _sgarcez$dof_calculator_elm$State$calcDOF(model.input)
							}),
...
var _sgarcez$dof_calculator_elm$State$defaultInput = {
	distance: {input: '100', parsed: 100.0, valid: true},
	aperture: {input: '1.4', parsed: 1.4, valid: true},
	focalLength: {input: '50', parsed: 50.0, valid: true}
};
var _sgarcez$dof_calculator_elm$State$init = {
	ctor: '_Tuple2',
	_0: {
		input: _sgarcez$dof_calculator_elm$State$defaultInput,
		dof: _sgarcez$dof_calculator_elm$State$calcDOF(_sgarcez$dof_calculator_elm$State$defaultInput)
	},
	_1: _elm_lang$core$Platform_Cmd$none
};

var _sgarcez$dof_calculator_elm$View$outputLine = function (value) {
	var _p0 = value;
	if (_p0.ctor === 'Just') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_myrho$elm_round$Round$round, 2, _p0._0),
			' cm');
	} else {
		return '';
	}
};
var _sgarcez$dof_calculator_elm$View$output = function (dof) {
	return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Near Point: ',
							_sgarcez$dof_calculator_elm$View$outputLine(dof.near))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Far Point: ',
								_sgarcez$dof_calculator_elm$View$outputLine(dof.far))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Difference: ',
									_sgarcez$dof_calculator_elm$View$outputLine(dof.diff))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _sgarcez$dof_calculator_elm$View$textInput = F3(
	function (title, param, msg) {
		var class_name = A2(
			_elm_lang$core$Basics_ops['++'],
			'form-control ',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(param.input),
								_1: {
									ctor: '::',
...
var _sgarcez$dof_calculator_elm$View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('form-wrap'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A3(_sgarcez$dof_calculator_elm$View$textInput, 'Distance(cm)', model.input.distance, _sgarcez$dof_calculator_elm$Types$SetDistance),
					_1: {
						ctor: '::',
						_0: A3(_sgarcez$dof_calculator_elm$View$textInput, 'Focal Length(mm)', model.input.focalLength, _sgarcez$dof_calculator_elm$Types$SetFocalLength),
						_1: {
							ctor: '::',
							_0: A3(_sgarcez$dof_calculator_elm$View$textInput, 'Aperture', model.input.aperture, _sgarcez$dof_calculator_elm$Types$SetAperture),
							_1: {
								ctor: '::',
								_0: _sgarcez$dof_calculator_elm$View$output(model.dof),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _sgarcez$dof_calculator_elm$App$main = _elm_lang$html$Html$program(
	{
		init: _sgarcez$dof_calculator_elm$State$init,
		update: _sgarcez$dof_calculator_elm$State$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		view: _sgarcez$dof_calculator_elm$View$root
	})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _sgarcez$dof_calculator_elm$App$main !== 'undefined') {
    _sgarcez$dof_calculator_elm$App$main(Elm['App'], 'App', undefined);
}
